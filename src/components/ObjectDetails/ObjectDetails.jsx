...
const ObjectDetails = ({place, selected, refProp}) => {
    ...
    return (
        <Card elevation={6}>
            <CardMedia
            style={{ height: 350 }}
            image={place.photo ? place.photo.images.large.url : 'https://live.staticflickr.com/65535/49443645382_36a114393b_b.jpg'}
            title={place.name}
            />
